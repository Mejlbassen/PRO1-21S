...
//          Person p = new Person(name, "Hansen", name + "@mail.com");
            Person p = new Person(name, "Hansen", "@mail.com", chkSenior);
...
//        persons.add(new Person("Pia", "Peters", "pia @eaaa.dk"));
        persons.add(new Person("Jens", "Jensen", "jens@eaaa", chkSenior));
        persons.add(new Person("Hans", "Hansen", "hans@eaaa.dk", chkSenior));
        persons.add(new Person("Pia", "Peters", "pia@eaaa.dk", chkSenior));
    }
