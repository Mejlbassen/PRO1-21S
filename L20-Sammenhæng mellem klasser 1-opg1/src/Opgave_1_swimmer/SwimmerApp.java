...
public class SwimmerApp {
    ...
    public static void main(String[] args) {
        ...
        for (Swimmer s : swimmers) {
            System.out.println(s.getTrainingPlan().getLevel());
        }

        System.out.println("All training hours:");
        System.out.println(s1.getAllTrainingHours());
        System.out.println(s2.getAllTrainingHours());
        System.out.println(s3.getAllTrainingHours());
