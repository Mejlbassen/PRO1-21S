...
public class EmployeePane extends GridPane {
	private TextField txfName, txfWage, txfCompany, txfSalary, txfEmployementYear;
	...
	public EmployeePane() {
		...
		Label lblEmployementYear = new Label("Employement Year:");
		this.add(lblEmployementYear, 1, 5);

		txfEmployementYear = new TextField();
		this.add(txfEmployementYear, 2, 5);
		txfEmployementYear.setPrefWidth(200);
		txfEmployementYear.setEditable(false);
