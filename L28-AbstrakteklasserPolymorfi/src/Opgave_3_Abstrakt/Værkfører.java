...
public class Værkfører extends Ansat {
    ...
    public Værkfører(String navn, String adresse, double timeLønssats, int årForSvendeprøve, int årForUdnævnelse, double tillægPerUge) {
    ...
    public double beregnLoen() {
        return getTimeLønssats() * 37 + tillægPerUge;
    }
}
