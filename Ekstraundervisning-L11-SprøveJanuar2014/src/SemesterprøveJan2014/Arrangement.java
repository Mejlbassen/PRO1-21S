...
public class Arrangement {
    ...
    public int getAntalLangeEvents() {
        int antal = 0;
        for (Event eventsTilGennemløb : events) {
            if (eventsTilGennemløb.getStartDato().until(eventsTilGennemløb.getSlutDato(), ChronoUnit.DAYS) + 1 > 3) {
                antal++;
            }
        }
        return antal;
