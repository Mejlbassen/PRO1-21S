...
public class Person {
    ...
    public String getInit() {
        ...
        } else return "" + firstName.charAt(0) + middleName.charAt(0)
                + lastName.charAt(0);
    }

    public String getUserName() {
        if (middleName == null) {
            String tekst4 = firstName.substring(0, 1);
            int tekst5 = firstName.length() - lastName.length();
            String tekst6 = lastName.substring(lastName.length() - 2);
        } else {
...
/*
Opgave 3: lav en constructor som kan virke uden mellemnavn.
this.middlename = null
 */